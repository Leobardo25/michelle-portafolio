        ...
        <section id="hero" className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden bg-brand-dark pt-20">
            ...
            <div className="container mx-auto px-6 relative z-10 text-center flex flex-col justify-center h-full">
                ...
                <h1 className="font-display text-4xl md:text-8xl font-black text-white mb-4 tracking-tighter animate-fade-in leading-tight">
                    TU OBSESIÓN <br /> <span className="text-brand-red">SECRETA</span>
                </h1>

                {/* Brief Description */}
                <p className="text-base md:text-lg text-brand-silver font-light mb-8 md:mt-12 tracking-wide max-w-xl mx-auto">
                    Contenido exclusivo, sin censura y totalmente personal. <br className="hidden md:block" />
                    Entra a mi mundo privado donde podras conocerme completa.🔥
                </p>
                ...
                <div className="flex justify-center gap-6 animate-fade-in mb-8" style={{ animationDelay: '0.4s' }}>
                    <a href="https://www.instagram.com/camiramirezcr_?igsh=MTZxeDAzOGhjamQyMQ==" target="_blank" rel="noopener noreferrer" className="text-brand-muted hover:text-brand-red transition-colors transform hover:scale-110">
                        {/* Instagram */}
                    ...
                    <a href="https://www.facebook.com/share/1AUzJQCupf/" target="_blank" rel="noopener noreferrer" className="text-brand-muted hover:text-brand-red transition-colors transform hover:scale-110">
                        {/* Facebook */}
                    ...
                    <a href={`https://wa.me/50660288198?text=${encodeURIComponent('Hola quiero comprar de tu contenido \u2764\uFE0F')}`} target="_blank" rel="noopener noreferrer" className="text-brand-muted hover:text-brand-red transition-colors transform hover:scale-110">
                        {/* WhatsApp */}
                ...
                <div className="flex flex-col items-center mt-12 mb-4">
                    <button onClick={scrollToAbout} className="animate-bounce cursor-pointer hover:text-brand-red transition-colors">
                        <svg className="w-12 h-12 md:w-16 md:h-16 mx-auto" style={{ color: '#E11D48' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
